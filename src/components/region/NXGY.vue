...
<template>
  <div class="GSwrap">
    <!-- 头部 -->
    <mt-header title="宁夏固原市" style="display: none">
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      post("/API/PoorHelpAPI/RegionalDetial?code=NXGY")
        .then(resp => {
          if (resp.ret != "0") {
            ...
            if (JSON.stringify(resp.data) == "{}") {
              ...
              that.StatisticsList[2].value =
                resp.data.BaseInfo.PoorFamily + "户";
